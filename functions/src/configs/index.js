...
const origin2 = (functions.config().origin2) ? functions.config().origin2.key : process.env.CEITSSAT_ORIGIN2;
const origin3 = (functions.config().origin3) ? functions.config().origin3.key : process.env.CEITSSAT_ORIGIN3;
const origin4 = (functions.config().origin4) ? functions.config().origin4.key : process.env.CEITSSAT_ORIGIN4;
const origin5 = (functions.config().origin5) ? functions.config().origin5.key : process.env.CEITSSAT_ORIGIN5;
